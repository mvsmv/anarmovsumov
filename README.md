...
В этот репозиторий я добавляю учебные проекты и pet-projects. 
...
Я показал несколько способов генерации данных, которые позволяют собрать свой датасет или дополнить датасет, например, с Kaggle нужными столбцами.
